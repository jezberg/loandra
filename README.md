...
Then ensure the maxpre2 and rustsat subfolders are updated. Newer versions of git do this automatically after cloning, with older versions you need to run git submodule init and 
git submodule update in the maxpre2 and rustsat subfolders. 
